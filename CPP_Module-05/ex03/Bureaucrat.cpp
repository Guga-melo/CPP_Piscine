...
/*   Updated: 2023/05/09 11:16:13 by gussoare         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(Form &form) const
{
	...
	{
		std::cerr << this->getName() << " cannot sign " << form.getName() << " form, because " << e.what() << std::endl;
	}
}
...
void	Bureaucrat::executeForm(Form const &form)
{
	...
	{
		std::cerr << this->getName() << " cannot execute " << form.getName() << " form, because " << e.what() << std::endl;
	}
}
